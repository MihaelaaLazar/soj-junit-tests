...
class ComputationUtilsTest {
    ...
    void maxIntAndANegativeNumber() {
        assertThat(com.endava.tmd.soj.junit5.p01.ComputationUtils.sum(Integer.MAX_VALUE, -1)).isEqualTo(2147483646);
    }
    ...
    void minIntAndAPositiveNumber() {
        assertThat(com.endava.tmd.soj.junit5.p01.ComputationUtils.sum(Integer.MIN_VALUE, 1)).isEqualTo(-2147483647);
    }
    ...
    void whatToDoWhenSumExceedsMaxIntegerValue() {
        assertThat(com.endava.tmd.soj.junit5.p01.ComputationUtils.sum(Integer.MAX_VALUE, 2)).isEqualTo(2147483649L);
    }
